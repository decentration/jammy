...
import { EncodableAccount, HostCallHandler }            from "../types";
...
export const infoHandler: HostCallHandler = (s, _id, env) => {
  ...
  let info: EncodableAccount | undefined = env.getInfo?.(srvIdx) as EncodableAccount ?? undefined; // (t) state of service account
