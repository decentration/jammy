...
export const TOTAL_ACCUMULATE_GAS = 10000000n; // GA : 11.30 => maximum total accumulate_gas
...
export const LOOKUP_ANCHOR_MAX_AGE = 14000 // Production: L = 14, 400: The maximum age in timeslots of the lookup anchor.
...
export const TOTAL_GAS_FOR_ALL_ACCUMULATION = 3500000000n; //GT = 3, 500, 000, 000: The total gas allocated across for all Accumulation. Should be no smaller than GA ⋅ C + ∑g∈V(χg )(g).
export const TOTAL_GAS_FOR_WORK_PACKAGE_REFINE_LOGIC = 5000000000n // GR = 5, 000, 000, 000: The gas allocated to invoke a work-package’s Refine logic.
