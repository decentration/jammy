...
export const LOOKUP_ANCHOR_MAX_AGE = 60 // Production: L = 14, 400: The maximum age in timeslots of the lookup anchor.
...
// Tiny chain parameters are defined by the official test-vectors chainspec:
// `external/jam-test-vectors/README.md` (Tiny):
...
export const MAX_EXTRINSICS_IN_WORK_PACKAGE = 10 // T = 10: Must be < E (epoch_duration=12) for tiny chain. Service validates T < E.
...
export const WE_OVERRIDE = 4;     // tiny chainspec: WE = 4 (vs graypaper 684)
export const WP_OVERRIDE = 1026;  // tiny chainspec: WP = 1026 (vs graypaper 6)
